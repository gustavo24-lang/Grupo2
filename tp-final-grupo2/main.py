...
for i in range(3):
    ...
    while len(str(numTelCliente)) != 10:
        print("ERROR-- El numero de telEfono debe tener exactamente 10 dIgitos, vuelva a ingresar.")
        numTelCliente = int(input("Ingrese su numero de telEfono: "))

    print("""Tenemos los siguientes descuentos y promociones:
    ...
    #  Envio
    # 0 = sin envIo, 1 = CABA, 2 = Provincia
    tipoEnvio = 0
    costoEnvio = 0

    # esta parte es para ver si eligio productos
    eligioProductos = False
        ...
        if ciclo == 1:
            print("""✔ Ha seleccionado SERVICIOS
              Estos son los servicios disponibles y sus precios:
                    ...
                    3. FULL:    $10.000
            """)
            OpcServicios = int(input("Ingrese el numero del servicio que desea: "))
            while OpcServicios < 1 or OpcServicios > 3:
                print("ERROR - ingrese una opcion valida del 1 al 3:")
            ...
            while OpcServicios != -1:
                if OpcServicios == 1:
                    ...
                    print("✔ Usted eligio FULL")
                    ContFull += 1
                    SumFull += 10000

                print("¿quiere repetir algun servicio o seleccionar otro? Ingrese 1 para LAVADO, 2 para CORTE, 3 para FULL o -1 para finalizar servicios:")
                OpcServicios = int(input("Ingrese una opcion de servicio: "))
